...
export function drawFinishedLettering(ctx,text,x,y,width,lineHeight,maxLines,finish,unit,drawRaw){
 ...
 const key=JSON.stringify([text,font,width*scale,lineHeight*scale,maxLines,finish,ctx.fillStyle,drawRaw.face]);
 ...
 if(!layer){
  ...
  c.font=font;c.textBaseline='top';c.fillStyle='#fff';drawRaw(c,text,pad,pad,width*scale,lineHeight*scale,maxLines);
